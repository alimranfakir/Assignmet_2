...
public class DetailsACtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            movieCast = new Gson().fromJson(data, Cast_Details.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    class MyAdapterCast extends RecyclerView.Adapter<CastHolder>{
        ...
        public CastHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(DetailsACtivity.this).inflate(R.layout.profile, parent, false);
